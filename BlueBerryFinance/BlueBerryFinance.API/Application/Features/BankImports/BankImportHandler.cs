...
using EntityCategory = BlueBerryFinance.API.Domain.Entities.Category;
using EntityStore = BlueBerryFinance.API.Domain.Entities.Store;
using EntityTransaction = BlueBerryFinance.API.Domain.Entities.Transaction;
...
namespace BlueBerryFinance.API.Application.Features.BankImports
{
    public class BankImportHandler : IBankImportHandler
    {
            ...
            Stream csvStream)
        {
            ...
            var toInsert = new List<EntityTransaction>();
