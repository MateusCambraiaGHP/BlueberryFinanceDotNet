...
using EntityCategory = BlueBerryFinance.API.Data.Entities.Category;
using EntityStore = BlueBerryFinance.API.Data.Entities.Store;
using EntityTransaction = BlueBerryFinance.API.Data.Entities.Transaction;
