...
{
    /// <summary>
    /// Streaming chat handler — entry point for the Blueberry Finance orchestrator.
    /// Uses IOrchestratorTools (4 tools) exclusively. Never exposes DB read/write tools directly.
    /// </summary>
    public class ChatHandler : IChatHandler
    {
            ...
            [EnumeratorCancellation] CancellationToken ct = default)
        {
            ...
            // Agentic loop: stream → handle tool calls → stream again until done
