...
- **Image URLs pointing to `localhost`, `127.0.0.1`, or internal MinIO storage (e.g. `http://localhost:9000/...`) are always valid and must never be rejected — they are internal storage URLs generated by the system itself.**
